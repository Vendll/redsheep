		...
		<div class="grid h-full place-content-center">
			<div class="relative mx-auto text-center max-w-7xl py-24 px-6 pt-32 lg:px-8">
				...
				<div class="flex mt-12 space-x-6 justify-center">
					<button type="button" class="btn variant-filled-primary uppercase font-semibold btn-lg"
						>Érdekel</button
					>
					<button
			...
			<section
				class="relative z-10 mx-auto max-w-7xl px-6 pb-24 lg:px-8"
				aria-labelledby="contact-heading"
			>
				<h2 class="sr-only" id="contact-heading">Contact us</h2>
				<div class="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
					<div
						class="flex flex-col rounded-2xl border border-gray-700 bg-gray-900/30 backdrop-blur-sm shadow-xl"
					>
						<div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
							<div
								class="absolute top-0 inline-block -translate-y-1/2 transform rounded-xl bg-primary-600 p-5 shadow-lg"
							>
							...
							<h3 class="text-xl font-medium text-white">MARKETING TANÁCSADÁS ÉS KIVITELEZÉS</h3>
					...
					>
						<div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
							...
							<h3 class="text-xl font-medium text-white">
								ONLINE MARKETING, GOOGLE ADS KAMPÁNYKEZELÉS
							</h3>
							<p class="mt-4 text-base text-gray-300">
								Varius facilisi mauris sed sit. Non sed et duis dui leo, vulputate id malesuada non.
								Cras aliquet purus dui laoreet diam sed lacus, fames.
					...
					>
						<div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
							...
							<h3 class="text-xl font-medium text-white">
								FACEBOOK TARTALOMGYÁRTÁS ÉS KAMPÁNYKEZELÉS
							</h3>
							<p class="mt-4 text-base text-gray-300">
								Varius facilisi mauris sed sit. Non sed et duis dui leo, vulputate id malesuada non.
								Cras aliquet purus dui laoreet diam sed lacus, fames.
