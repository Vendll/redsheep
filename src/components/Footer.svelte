...
<footer class="bg-secondary-800">
	<div class="mx-auto max-w-7xl overflow-hidden py-20 px-6 sm:py-24 lg:px-8">
		<nav class="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12" aria-label="Footer">
			...
			<!-- <div class="pb-6">
				<a href={footer.a} class="text-sm leading-6 text-gray-400 hover:text-gray-300">Jobs</a>
			</div>

			<div class="pb-6">
				<a href={footer.a} class="text-sm leading-6 text-gray-400 hover:text-gray-300">Press</a>
			</div>

			<div class="pb-6">
				<a href={footer.a} class="text-sm leading-6 text-gray-400 hover:text-gray-300">Accessibility</a>
			</div> -->
