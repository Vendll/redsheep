	...
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mx-auto max-w-4xl lg:text-center">
			...
			<p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
				A céged új marketinges kollégája egy egész csapat tudásával.
			</p>
			<p class="mt-6 text-lg leading-8 text-gray-500">
				Vagyis olyanok vagyunk, mint egy belsős marketinges kolléga, aki mindent megcsinál neked.
				Legyen szó online kommunikációról, rendezvényszervezésről, médiavásárlásról, grafikai
				tervezésről, reklámszpot vagy videó készítéséről, fotózásról nekünk mindenre megvan a
				tökéletes szakemberünk és kiterjedt kapcsolatrendszerünknek köszönhetően az ismeretlen
				tereptől sem hátrálunk meg.
			</p>
		</div>
			...
			>
				...
				<div class="relative p-6 rounded-[--theme-rounded-base] variant-filled-primary">
					<div class="relative pl-16">
						<dt class="text-base font-semibold leading-7 text-white">
							<div
								class="absolute top-0 left-0 flex h-10 w-10 items-center justify-center rounded-lg bg-white"
							>
